<template>
  <div>
    <page-title :createProcessName="createProcessName" :heading="$store.state.t('Regions')" :subheading="$store.state.t('Regions actions')" icon='pe-7s-global icon-gradient bg-happy-itmeo' :starShow=false></page-title>
    ...
    <b-card :title="$store.state.t('Regions')" class="main-card mb-4">
      <b-row class="mb-3">
