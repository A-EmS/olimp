<template>
  <div>
    <page-title :button-action-hide="getACL().create !== true" :createProcessName="createProcessName" :heading="$store.state.t('Entities')" :subheading="$store.state.t('Entities actions')" icon='pe-7s-keypad icon-gradient bg-happy-itmeo' :starShow=false></page-title>
    ...
    <b-card v-if="getACL().list === true" v-show="showList" :title="$store.state.t('Entities')" class="main-card mb-4">
      <b-row class="mb-3">
