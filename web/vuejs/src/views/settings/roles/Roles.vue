...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      updateItemListEventName: 'updateList:Roles',
      createProcessName: 'create:roles',
      updateProcessName: 'update:roles',
      configureProcessName: 'configure:roles',
      confirmatorInputProcessName: 'confirm:roles',
      confirmatorOutputProcessName: 'confirmed:roles',
    ...
    methods: {
      ...
      confirmDeleteRow: function(id, name){
        this.$eventHub.$emit(this.confirmatorInputProcessName, {
          ...
          confirmString: this.$store.state.t('Confirm delete') +  ' ' + this.$store.state.t('Role') +'..'+name,
          idToConfirm: id
        });
      },
      ...
      deleteRow: function(id){
        ...
        this.rolesManager.delete({id:id})
                .then( (response) => {
                  if(response.data !== false){
