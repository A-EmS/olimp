<template>
  <div>
    ...
    <form_component v-if="getACL().update === true" :createProcessNameTrigger="createProcessName" :updateProcessNameTrigger="updateProcessName" :updateItemListNameTrigger="updateItemListEventName" :updateTabsTrigger="updateTabsTrigger" ></form_component>
...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      updateTabsTrigger: 'updateList:updateTabsTrigger',
