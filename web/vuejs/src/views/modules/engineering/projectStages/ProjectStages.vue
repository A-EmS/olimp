<template>
  <div>
    <page-title :button-action-hide="getACL().create !== true" :createProcessName="createProcessName" :heading="$store.state.t('Project Stages')" :subheading="$store.state.t('Project Stages actions')" icon='lnr-list icon-gradient bg-happy-itmeo' :starShow=false></page-title>
    ...
    <b-card v-if="getACL().list === true" :title="$store.state.t('Project Stages')" class="main-card mb-4">
      <b-row class="mb-3">
