...
class m200719_194320_create_table_serviceProperty extends Migration
{
    ...
    public function up()
    {
        $this->execute('CREATE TABLE `service_property` (
        ...
        $this->execute('CREATE TABLE `service_property_value` (
              `id` int(11) NOT NULL AUTO_INCREMENT,
        ...
        $this->execute('CREATE TABLE `finance_documents` (
              `id` int(11) NOT NULL AUTO_INCREMENT,
        ...
        $this->execute('CREATE TABLE `account_content` (
              `id` int(11) NOT NULL AUTO_INCREMENT,
        ...
        $this->execute('CREATE TABLE `finance_book` (
              `id` int(11) NOT NULL AUTO_INCREMENT,
              `account_id` int(11) NOT NULL,
              `service_id` int(11) NOT NULL,
              `service_account_price` DECIMAL(10,2),
        ...
        $this->execute('CREATE TABLE `finance_operation_type` (
              `id` int(11) NOT NULL AUTO_INCREMENT,
              `name` varchar(255) NOT NULL,
              `create_user` int(11) DEFAULT \'0\',
              `create_date` datetime DEFAULT NULL,
        ...
        $this->execute('CREATE TABLE `finance_calendar` (
              `id` int(11) NOT NULL AUTO_INCREMENT,
              `account_id` int(11) NOT NULL,
